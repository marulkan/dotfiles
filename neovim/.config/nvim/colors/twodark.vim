" Vim Color File
" Name:       twodark.vim
" Maintainer: https://github.com/joshdick/twodark.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/MaxSt/FlatColor/

" A companion [vim-airline](https://github.com/bling/vim-airline) theme is available at: https://github.com/joshdick/airline-twodark.vim
...
" < https://github.com/joshdick/twodark.vim/blob/master/README.md >
...
function! s:h(group, style)
  if g:twodark_terminal_italics == 0
...
function! twodark#set_highlight(group, style)
...
let s:red = { "gui": "#E84F4F", "cterm": "204", "cterm16": "1" }
let s:dark_red = { "gui": "#D23D3D", "cterm": "196", "cterm16": "9" }

let s:green = { "gui": "#B7CE42", "cterm": "114", "cterm16": "2" }

let s:yellow = { "gui": "#EFEA63C", "cterm": "180", "cterm16": "3" }
let s:dark_yellow = { "gui": "#FFE864", "cterm": "173", "cterm16": "11" }

let s:blue = { "gui": "#66AABB", "cterm": "39", "cterm16": "4" }

let s:purple = { "gui": "#B7416E", "cterm": "170", "cterm16": "5" }

let s:cyan = { "gui": "#6D878D", "cterm": "38", "cterm16": "6" }

let s:white = { "gui": "#DDDDDD", "cterm": "145", "cterm16": "7" }

let s:black = { "gui": "#111111", "cterm": "235", "cterm16": "0" }
